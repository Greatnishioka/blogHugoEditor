...
export default function ListTable({focus,handleTabChange}: Props) {
    return (
    <>
        <li onClick={(()=>{handleTabChange("heading")})} className={`absolute top-0 flex justify-start items-start text-[#62BAA5] transition-transform duration-100 ${focus ? "z-50 translate-x-0" : "z-30 -translate-x-[10px]"}`}>
            <div className="absolute -left-[1px] top-[320px]">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="73" height="262" viewBox="0 0 73 262">
                    <g id="tab" transform="translate(73) rotate(90)">
                        <path id="パス_50" data-name="パス 50" d="M50.937.713c-5.75.853-16.43,4.915-20.437,28.864C24.8,63.63,17.1,72.5,0,72.5H262c-17.1,0-24.8-8.869-30.5-42.923C227.492,5.628,216.813,1.566,211.063.713A10,10,0,0,0,209,.5H53a9.976,9.976,0,0,0-2.063.213" fill="#96DECD" fill-rule="evenodd"/>
