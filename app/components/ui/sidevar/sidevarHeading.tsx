...
export default function Heading({children,focus,handleTabChange}: Props) {
    return (
    <>
        <li onClick={(()=>{handleTabChange("heading")})} className={`absolute top-0 flex justify-start items-start text-[#62BAA5] transition-transform duration-100 cursor-pointer ${focus ? "z-50 translate-x-0" : "z-40 -translate-x-[10px]"}`}>
            <div className="absolute -left-[1px] -top-[40px]">
                <hgroup className="w-max absolute flex flex-col items-center gap-0 rotate-90 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <h3 className="text-[27px] font-bold">見出し</h3>
                    <p className="text-[14px] relative -top-[8px]">Heading</p>
                </hgroup>
                <svg xmlns="http://www.w3.org/2000/svg" width="73" height="262" viewBox="0 0 73 262">
                    <g id="tab" transform="translate(73) rotate(90)">
                        <path id="パス_50" data-name="パス 50" d="M50.937.713c-5.75.853-16.43,4.915-20.437,28.864C24.8,63.63,17.1,72.5,0,72.5H262c-17.1,0-24.8-8.869-30.5-42.923C227.492,5.628,216.813,1.566,211.063.713A10,10,0,0,0,209,.5H53a9.976,9.976,0,0,0-2.063.213" fill="white" fillRule="evenodd"/>
